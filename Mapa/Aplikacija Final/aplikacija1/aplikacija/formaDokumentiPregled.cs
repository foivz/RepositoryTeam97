...
namespace aplikacija
{
    ...
    {
        //Riješenje pomoću DataSet-ova
        public formaDokumentiPregled()
        {
            InitializeComponent();
        }

        DateTimePicker dtpDokument; //koristi se u datagridview-u za odabir datuma
        ...
        private void formaDokumentiPregled_Load(object sender, EventArgs e)
        {
            ...
            //postavljamo dtp u datagridview te pozivamo događaje za početak i kraj odabira odnosno promjene vrijednosti
        ...
        /// <summary>
        /// Prikaz stavki dokumenta ovisno od odabiru (SelectionChanged) dokumenta. (DataSet)
        /// </summary>
        ...
        //Upravljanje događajem za odabir datuma u ćeliji preko dtp-a. Početni je današnji datum
        ...
        /// <summary>
        /// Upravljanje događajem u ćeliji nakon odabira iz datetime pickera
        /// </summary>
