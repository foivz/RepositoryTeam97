...
namespace aplikacija
{
    public partial class formaStatistikaKlase : Form
    {
        ...
        private void formaStatistikaKlase_Load(object sender, EventArgs e)
        {
            ...
            this.chart1.Series["Klasa A"].Points.AddXY("Artikl", klasaA);
            this.chart1.Series["Klasa B"].Points.AddXY("Artikl", klasaB);
            this.chart1.Series["Klasa C"].Points.AddXY("Artikl", klasaC);
        }
    }
}
